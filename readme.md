# 说明 
本项目是从[jcobcyl/Aliyun-oss-storage](https://github.com/jacobcyl/Aliyun-oss-storage)借鉴过来的，由于引入该项目是，项目会出错，就自己放到自己的githun上了。
...
In order to install AliOSS-storage, just add
    ...
    "zhchi/ali-oss-storage": "^2.1"

to your composer.json. Then run `composer install` or `composer update`.  
Or you can simply run below command to install:

    "composer require zhchi/ali-oss-storage:^2.0"
    
Then in your `config/app.php` add this line to providers array:
```php
Zhchi\AliOSS\AliOssServiceProvider::class,
```
## Configuration
